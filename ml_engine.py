...
_SUBJECT_SIGNALS: dict[str, list[tuple[str, float]]] = {
    ...
    "Textiles and Design":            [("q8", 0.7), ("q3", 0.3)],
...
def _subjects_for_cluster(cluster: str, answers: dict | None = None) -> list[dict]:
    ...
    descriptions = {
        ...
        "Textiles and Design":            "Design and create textile products combining creativity with technical skills. Ideal for students interested in fashion, design, or textile industries.",
